...
\newcommand{\repertoire}{D}
\newcommand{\chap}[1]{\include{\repertoire/#1}}
...
\newcommand{\jlangfr} {
    ...
    \renewcommand{\textAuthor}{Auteurs}
}
...
\newcommand{\jlangen} {
    ...
    \renewcommand{\textAuthor}{Authors}
}

% \jkeyword {keyword}
\newcommand{\jkeyword}[1] {\clearpage\section*{#1}%
